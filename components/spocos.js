...
import { COLOR, DELETE, EDIT, NEW, SPONSORSHIP, VIEW } from '../constants'
...
import Modal, { Label, LogoImage, ModalContent, ModalField, UploadContainer } from './modal'
      ...
      <Card>
        ...
        <CardContent>
          <TableContainer>
            ...
            {!isLoading && !showItems && (
              <CardContainer padding="22px 28px">No sponsorships for {hackathonId} :(</CardContainer>
            )}
      ...
      >
        <ModalContent page={SPONSORSHIP}>
          ...
          <div>
            ...
            <UploadContainer type="text" value={newobj.imgName} onClick={fileClick} disabled={modalAction === VIEW} />
          </div>
        </ModalContent>
      </Modal>
    </>
